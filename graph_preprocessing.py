...
mol0 = get_mol(data[130000], explicit_H=True)
...
SAMPLE_MOL = mol2graph(data[130000], explicit_H=True)
...
for i in range(len(X_train)):
    try:
        ...
        print(i)
        graph = mol2graph(X_train[i], block=True)
        train_graphs.append(graph)
        pass
...
for i in range(len(X_test)):
    try:
        ...
        print(i)
        graph = mol2graph(X_test[i], block=True)
        test_graphs.append(graph)
